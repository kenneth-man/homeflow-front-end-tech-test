...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.scss */ \"./src/styles.scss\");\n/* harmony import */ var core_js_stable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/stable */ \"./node_modules/core-js/stable/index.js\");\n/* harmony import */ var core_js_stable__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_stable__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! regenerator-runtime/runtime */ \"./node_modules/regenerator-runtime/runtime.js\");\n/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _public_res_homeflow_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../public/res/homeflow.jpg */ \"./public/res/homeflow.jpg\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\nvar page = document.querySelector('.page');\nvar modal = document.querySelector('.modal');\nvar searchbarButton = document.querySelector('#searchbar-search');\nvar searchbarLocation = document.querySelector('#searchbar-location');\nvar searchbarPrice = document.querySelector('#searchbar-price');\nvar searchbarPriceNumber = document.querySelector('#searchbar-price-number');\nvar searchbarStatus = document.querySelector('#searchbar-status');\nvar modalCont = document.querySelector('#modal-cont');\nvar modalExit = document.querySelector('#modal-exit');\nvar searchbarFilters = [searchbarPrice, searchbarStatus]; //used for modal element; if using react, would use context state with routing to new page instead of modal\n\nvar allData = []; //render results\n\nvar renderPageData = function renderPageData(data) {\n  page.innerHTML = '';\n  data.length > 0 ? data.forEach(function (curr, index) {\n    return page.insertAdjacentHTML('beforeend', \"\\n            <div \\n                class='col result' \\n                style='background-image: linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(\".concat(curr.photos.length > 0 ? \"http://mr1.homeflow.co.uk/\".concat(curr.photos[0]) : _public_res_homeflow_jpg__WEBPACK_IMPORTED_MODULE_3__, \")'\\n                id=\").concat(index, \"\\n            >\\n                <h1>\").concat(curr.bedrooms, \" bedroom \").concat(curr.property_type, \"</h1>\\n                <h2>'\").concat(curr.status, \"'</h2>\\n                <h2>Valued at \\xA3\").concat(curr.price_value.toLocaleString(), \"</h2>\\n                <h3>\").concat(curr.town ? curr.town : '(N/A)', \", \").concat(curr.postcode, \"</h3>\\n            </div>\\n        \"));\n  }) : page.insertAdjacentHTML('beforeend', \"\\n            <div class='noData'>\\n                <em><h1>No property data found...</h1></em>\\n            </div>\\n        \");\n}; //render modal data\n\n\nvar renderModalData = function renderModalData(idIndex) {\n  modalCont.innerHTML = '';\n  var modalData = allData[Number(idIndex)];\n  var bedrooms = modalData.bedrooms,\n      property_type = modalData.property_type,\n      status = modalData.status,\n      price_value = modalData.price_value,\n      town = modalData.town,\n      postcode = modalData.postcode,\n      contact_telephone = modalData.contact_telephone,\n      short_description = modalData.short_description,\n      links = modalData.links;\n  modalCont.insertAdjacentHTML('afterbegin', \"\\n            <h1>\".concat(bedrooms, \" bedroom \").concat(property_type, \"</h1>\\n            <h2>'\").concat(status, \"'</h2>\\n            <h2>Valued at \\xA3\").concat(price_value.toLocaleString(), \"</h2>\\n            <h3>\").concat(town ? town : '(N/A)', \", \").concat(postcode, \"</h3>\\n            <h3>Please call \").concat(contact_telephone, \" if interested</h3>\\n            <p>\").concat(short_description, \"</p>\\n            <a href='\").concat(links.length > 0 ? links[0].url : 'https://www.homeflow.co.uk/', \"'>View details</a>\\n        \"));\n}; //fetch api data\n\n\nvar fetchData = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(location) {\n    var filterArray,\n        response,\n        renderData,\n        data,\n        dataArray,\n        _args = arguments;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            filterArray = _args.length > 1 && _args[1] !== undefined ? _args[1] : false;\n            _context.prev = 1;\n\n            if (!location) {\n              _context.next = 8;\n              break;\n            }\n\n            _context.next = 5;\n            return fetch(\"/api/properties?location=\".concat(location));\n\n          case 5:\n            response = _context.sent;\n            _context.next = 9;\n            break;\n\n          case 8:\n            throw new Error('Empty location name');\n\n          case 9:\n            _context.next = 11;\n            return response.json();\n\n          case 11:\n            data = _context.sent;\n            dataArray = data.result.properties.elements; //filter the 'dataArray' based on filters if any\n\n            if (filterArray && filterArray.length > 0) {\n              renderData = dataArray.filter(function (curr) {\n                return filterArray.every(function (filter) {\n                  if (filter.id === 'searchbar-price' && Number(filter.value) >= curr.price_value) {\n                    return true;\n                  } else if (filter.id === 'searchbar-status' && filter.value === curr.status) {\n                    return true;\n                  } else {\n                    return false;\n                  }\n                });\n              });\n            } else {\n              renderData = dataArray;\n            }\n\n            allData = renderData;\n            renderPageData(renderData);\n            _context.next = 21;\n            break;\n\n          case 18:\n            _context.prev = 18;\n            _context.t0 = _context[\"catch\"](1);\n            alert(\"Error: \".concat(_context.t0.message));\n\n          case 21:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[1, 18]]);\n  }));\n\n  return function fetchData(_x) {\n    return _ref.apply(this, arguments);\n  };\n}(); //page delegation for all results; too performance intensive to add an event listener to each result, so only need to add to parent\n\n\npage.addEventListener('click', function (e) {\n  if (e.target.classList.contains('result') || e.target.closest('.result')) {\n    e.target.classList.contains('result') ? renderModalData(e.target.id) : renderModalData(e.target.closest('.result').id);\n    modal.classList.remove('modal__hidden');\n  }\n}); //update the 'searchbarPrice' whenever range input is changed\n\nsearchbarPrice.addEventListener('input', function () {\n  return searchbarPriceNumber.textContent = \"\\xA3\".concat(Number(searchbarPrice.value).toLocaleString());\n}); //'searchbarButton' on click; only parse the non-empty input values as an array; doing this methodology incase need more filters in the future in 'searchbarFilters'\n\nsearchbarButton.addEventListener('click', function () {\n  var filters = searchbarFilters.map(function (curr) {\n    return {\n      id: curr.id,\n      value: Number(curr.value) === 0 ? Number(curr.value) : curr.value\n    };\n  });\n  var truthyFilters = filters.filter(function (curr) {\n    return curr.value;\n  });\n  fetchData(searchbarLocation.value, truthyFilters);\n}); //'modalExit' on click; to exit modal\n\nmodalExit.addEventListener('click', function () {\n  return modal.classList.add('modal__hidden');\n}); //fetch on initial page render\n\nfetchData('london');\n\n//# sourceURL=webpack://my-webpack-project/./src/index.js?");
...
"use strict";
eval("module.exports = __webpack_require__.p + \"5afcd8c160b04726aeaa.jpg\";\n\n//# sourceURL=webpack://my-webpack-project/./public/res/banner.jpg?");

/***/ }),

/***/ "./public/res/homeflow.jpg":
/*!*********************************!*\
  !*** ./public/res/homeflow.jpg ***!
  \*********************************/
/***/ ((module) => {
...
"use strict";
eval("module.exports = \"data:image/jpeg;base64,\";\n\n//# sourceURL=webpack://my-webpack-project/./public/res/homeflow.jpg?");
